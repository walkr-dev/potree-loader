 ...
 *
 * @class
 */ const $23fd448c909cb165$export$4a34a80e6342e491 = {
    DATA_TYPE_DOUBLE: {
        ordinal: 0,
        name: "double",
        size: 8
...
let $23fd448c909cb165$var$i = 0;
for(let obj in $23fd448c909cb165$export$4a34a80e6342e491){
    $23fd448c909cb165$export$4a34a80e6342e491[$23fd448c909cb165$var$i] = $23fd448c909cb165$export$4a34a80e6342e491[obj];
    $23fd448c909cb165$var$i++;
}
// Class that represents a certain point attribute
class $23fd448c909cb165$export$4fe36b08757d7602 {
...
const $23fd448c909cb165$export$c9c943992b7ca9cc = {
    POSITION_CARTESIAN: new $23fd448c909cb165$export$4fe36b08757d7602("POSITION_CARTESIAN", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_FLOAT, 3),
    RGBA_PACKED: new $23fd448c909cb165$export$4fe36b08757d7602("COLOR_PACKED", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_INT8, 4),
    COLOR_PACKED: new $23fd448c909cb165$export$4fe36b08757d7602("COLOR_PACKED", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_INT8, 4),
    RGB_PACKED: new $23fd448c909cb165$export$4fe36b08757d7602("COLOR_PACKED", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_INT8, 3),
    NORMAL_FLOATS: new $23fd448c909cb165$export$4fe36b08757d7602("NORMAL_FLOATS", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_FLOAT, 3),
    INTENSITY: new $23fd448c909cb165$export$4fe36b08757d7602("INTENSITY", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT16, 1),
    CLASSIFICATION: new $23fd448c909cb165$export$4fe36b08757d7602("CLASSIFICATION", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT8, 1),
    NORMAL_SPHEREMAPPED: new $23fd448c909cb165$export$4fe36b08757d7602("NORMAL_SPHEREMAPPED", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT8, 2),
    NORMAL_OCT16: new $23fd448c909cb165$export$4fe36b08757d7602("NORMAL_OCT16", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT8, 2),
    NORMAL: new $23fd448c909cb165$export$4fe36b08757d7602("NORMAL", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_FLOAT, 3),
    RETURN_NUMBER: new $23fd448c909cb165$export$4fe36b08757d7602("RETURN_NUMBER", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT8, 1),
    NUMBER_OF_RETURNS: new $23fd448c909cb165$export$4fe36b08757d7602("NUMBER_OF_RETURNS", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT8, 1),
    SOURCE_ID: new $23fd448c909cb165$export$4fe36b08757d7602("SOURCE_ID", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT16, 1),
    INDICES: new $23fd448c909cb165$export$4fe36b08757d7602("INDICES", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_UINT32, 1),
    SPACING: new $23fd448c909cb165$export$4fe36b08757d7602("SPACING", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_FLOAT, 1),
    GPS_TIME: new $23fd448c909cb165$export$4fe36b08757d7602("GPS_TIME", $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_DOUBLE, 1)
};
class $23fd448c909cb165$export$33a55c29cc28473e {
    ...
    constructor(pointAttributes, attributes = [], byteSize = 0, size = 0, vectors = []){
        ...
        if (pointAttributes != null) for(let i = 0; i < pointAttributes.length; i++){
            ...
            let pointAttribute = $23fd448c909cb165$export$c9c943992b7ca9cc[pointAttributeName];
    ...
    hasNormals() {
        for(let name in this.attributes){
            ...
            if (pointAttribute === $23fd448c909cb165$export$c9c943992b7ca9cc.NORMAL_SPHEREMAPPED || pointAttribute === $23fd448c909cb165$export$c9c943992b7ca9cc.NORMAL_FLOATS || pointAttribute === $23fd448c909cb165$export$c9c943992b7ca9cc.NORMAL || pointAttribute === $23fd448c909cb165$export$c9c943992b7ca9cc.NORMAL_OCT16) return true;
        }
        return false;
    }
}
...
*/ /** @return {function(!Int8Array):!Int8Array} */ function $4850934860c39869$var$BrotliDecodeClosure() {
    /** @type {!Int8Array} */ var DICTIONARY_DATA = new Int8Array(0);
    /**
   * @constructor
   * @param {!Int8Array} bytes
   * @struct
   */ function InputStream(bytes) {
        /** @type {!Int8Array} */ this.data = bytes;
   ...
   */ function unpackCommandLookupTable(cmdLookup) {
        ...
        for(var /** number */ cmdCode = 0; cmdCode < 704; ++cmdCode){
            ...
            var /** number */ insertCode = (170064 >>> rangeIdx * 2 & 3) << 3 | cmdCode >>> 3 & 7;
            var /** number */ copyCode = (156228 >>> rangeIdx * 2 & 3) << 3 | cmdCode & 7;
   ...
   */ function enableEagerOutput(s) {
        if (s.runningState != 1) throw "State MUST be freshly initialized";
        s.isEager = 1;
    }
    /**
   * @param {!State} s
   ...
   */ function initState(s, input) {
        if (s.runningState != 0) throw "State MUST be uninitialized";
        s.blockTrees = new Int32Array(3091);
        s.blockTrees[0] = 7;
        s.distRbIdx = 3;
        var /** number */ maxDistanceAlphabetLimit = calculateDistanceAlphabetLimit(2147483644, 3, 120);
   ...
   * @return {void}
   */ function close(s) {
        if (s.runningState == 0) throw "State MUST be initialized";
        if (s.runningState == 11) return;
        s.runningState = 11;
        if (s.input != null) {
            closeInput(s.input);
            s.input = null;
   ...
   */ function decodeVarLenUnsignedByte(s) {
        ...
        if (readFewBits(s, 1) != 0) {
            var /** number */ n = readFewBits(s, 3);
            if (n == 0) return 1;
            else return readFewBits(s, n) + (1 << n);
        }
        return 0;
    }
    /**
   ...
   */ function decodeMetaBlockLength(s) {
        ...
        s.isUncompressed = 0;
        s.isMetadata = 0;
        if (s.inputEnd != 0 && readFewBits(s, 1) != 0) return;
        var /** number */ sizeNibbles = readFewBits(s, 2) + 4;
        if (sizeNibbles == 7) {
            s.isMetadata = 1;
            if (readFewBits(s, 1) != 0) throw "Corrupted reserved bit";
            ...
            for(var /** number */ i = 0; i < sizeBytes; i++){
                ...
                if (bits == 0 && i + 1 == sizeBytes && sizeBytes > 1) throw "Exuberant nibble";
                s.metaBlockLength |= bits << i * 8;
            }
        } else for(var /** number */ i = 0; i < sizeNibbles; i++){
            if (s.bitOffset >= 16) {
                s.accumulator32 = s.shortBuffer[s.halfOffset++] << 16 | s.accumulator32 >>> 16;
                s.bitOffset -= 16;
            }
            var /** number */ bits = readFewBits(s, 4);
            if (bits == 0 && i + 1 == sizeNibbles && sizeNibbles > 4) throw "Exuberant nibble";
   ...
   */ function readSymbol(tableGroup, tableIdx, s) {
        ...
        var /** number */ sym = tableGroup[offset] & 65535;
        if (bits <= 8) {
            s.bitOffset += bits;
            return sym;
        }
   ...
   */ function inverseMoveToFrontTransform(v, vLen) {
        ...
        for(var /** number */ i = 0; i < 256; i++)mtf[i] = i;
        for(var /** number */ i = 0; i < vLen; i++){
            var /** number */ index = v[i] & 255;
            v[i] = mtf[index];
   ...
   */ function readHuffmanCodeLengths(codeLengthCodeLengths, numSymbols, codeLengths, s) {
        ...
        var /** !Int32Array */ table = new Int32Array(33);
        ...
        while(symbol < numSymbols && space > 0){
            ...
            var /** number */ codeLen = table[p] & 65535;
            if (codeLen < 16) {
                repeat = 0;
                ...
                for(var /** number */ i = 0; i < repeatDelta; i++)codeLengths[symbol++] = repeatCodeLen;
   ...
   */ function checkDupes(symbols, length) {
        for(var /** number */ i = 0; i < length - 1; ++i)for(var /** number */ j = i + 1; j < length; ++j){
            if (symbols[i] == symbols[j]) throw "Duplicate simple Huffman code symbol";
        }
    }
    /**
   ...
   */ function readComplexHuffmanCode(alphabetSizeLimit, skip, tableGroup, tableIdx, s) {
        ...
        for(var /** number */ i = skip; i < 18 && space > 0; i++){
            ...
            var /** number */ v = FIXED_TABLE[p] & 65535;
   ...
   */ function readHuffmanCode(alphabetSizeMax, alphabetSizeLimit, tableGroup, tableIdx, s) {
        ...
        else return readComplexHuffmanCode(alphabetSizeLimit, simpleCodeOrSkip, tableGroup, tableIdx, s);
    }
    /**
   ...
   */ function maybeReallocateRingBuffer(s) {
        ...
        if (s.ringBuffer.length != 0) newBuffer.set(s.ringBuffer.subarray(0, 0 + s.ringBufferSize), 0);
   ...
   */ function readMetablockHuffmanCodesAndContextMaps(s) {
        ...
        for(var /** number */ j = 0; j < s.numLiteralBlockTypes << 6; j++)if (s.contextMap[j] != j >> 6) {
   ...
   */ function calculateFence(s) {
        ...
        if (s.isEager != 0) result = min(result, s.ringBufferBytesWritten + s.outputLength - s.outputUsed);
        return result;
    }
    /**
   * @param {!State} s
   ...
   */ function decompress(s) {
        if (s.runningState == 0) throw "Can't decompress until initialized";
        if (s.runningState == 11) throw "Can't decompress after close";
        if (s.runningState == 1) {
        ...
        while(s.runningState != 10)switch(s.runningState){
            ...
            case 4:
                ...
                var /** number */ extraBits = insertAndCopyExtraBits & 255;
            ...
            case 7:
                if (s.trivialLiteralContext != 0) while(s.j < s.insertLength){
                    ...
                    var /** number */ prevByte1 = ringBuffer[s.pos - 1 & ringBufferMask] & 255;
                    var /** number */ prevByte2 = ringBuffer[s.pos - 2 & ringBufferMask] & 255;
                    while(s.j < s.insertLength){
                        if (s.halfOffset > 2030) doReadMoreInput(s);
                        if (s.literalBlockLength == 0) decodeLiteralBlockSwitch(s);
                        var /** number */ literalContext = LOOKUP[s.contextLookupOffset1 + prevByte1] | LOOKUP[s.contextLookupOffset2 + prevByte2];
                        var /** number */ literalTreeIdx = s.contextMap[s.contextMapSlice + literalContext] & 255;
                        s.literalBlockLength--;
                        prevByte2 = prevByte1;
                        if (s.bitOffset >= 16) {
                            s.accumulator32 = s.shortBuffer[s.halfOffset++] << 16 | s.accumulator32 >>> 16;
                ...
                if (distanceCode < 0) s.distance = s.rings[s.distRbIdx];
                    ...
                    var /** number */ distTreeIdx = s.distContextMap[s.distContextMapSlice + distanceCode] & 255;
                    distanceCode = readSymbol(s.distanceTreeGroup, distTreeIdx, s);
                    if (distanceCode < 16) {
                        var /** number */ index = s.distRbIdx + DISTANCE_SHORT_CODE_INDEX_OFFSET[distanceCode] & 3;
            ...
            case 8:
                ...
                if (srcEnd < ringBufferMask && dstEnd < ringBufferMask) {
                    if (copyLength < 12 || srcEnd > dst && dstEnd > src) for(var /** number */ k = 0; k < copyLength; k += 4){
                ...
                continue;
            case 9:
                if (s.distance > 2147483644) throw "Invalid backward reference";
   ...
   */ function Transforms(numTransforms, prefixSuffixLen, prefixSuffixCount) {
        /** @type {!number} */ this.numTransforms = 0;
        /** @type {!Int32Array} */ this.triplets = new Int32Array(0);
        /** @type {!Int8Array} */ this.prefixSuffixStorage = new Int8Array(0);
        /** @type {!Int32Array} */ this.prefixSuffixHeads = new Int32Array(0);
        /** @type {!Int16Array} */ this.params = new Int16Array(0);
   ...
   */ function unpackTransforms(prefixSuffix, prefixSuffixHeads, transforms, prefixSuffixSrc, transformsSrc) {
        ...
        for(var /** number */ i = 0; i < 363; ++i)transforms[i] = transformsSrc.charCodeAt(i) - 32;
    }
   ...
   */ function transformDictionaryWord(dst, dstOffset, src, srcOffset, len, transforms, transformIndex) {
        ...
        if (transformType == 10 || transformType == 11) {
            ...
            while(len > 0){
                var /** number */ c0 = dst[uppercaseOffset] & 255;
                if (c0 < 192) {
            ...
            var /** number */ scalar = (param & 32767) + (16777216 - (param & 32768));
            while(len > 0){
                var /** number */ step = 1;
                var /** number */ c0 = dst[shiftOffset] & 255;
                if (c0 < 128) {
                    scalar += c0;
   ...
   */ function buildHuffmanTable(tableGroup, tableIdx, rootBits, codeLengths, codeLengthsSize) {
        ...
        offset[1] = 0;
        for(var /** number */ len = 1; len < 15; len++)offset[len + 1] = offset[len] + count[len];
        ...
        key = 0;
        symbol = 0;
        for(var /** number */ len = 1, step = 2; len <= rootBits; len++, step <<= 1)for(; count[len] > 0; count[len]--){
        ...
        for(var /** number */ len = rootBits + 1, step = 2; len <= 15; len++, step <<= 1)for(; count[len] > 0; count[len]--){
            if ((key & mask) != low) {
   ...
   */ function checkHealth(s, endOfStream) {
        if (s.endOfStreamReached == 0) return;
        var /** number */ byteOffset = (s.halfOffset << 1) + (s.bitOffset + 7 >> 3) - 4;
        if (byteOffset > s.tailBytes) throw "Read after end";
        if (endOfStream != 0 && byteOffset != s.tailBytes) throw "Unused bytes after end";
    }
    /**
   * @param {!State} s
   * @return {void}
   */ function assertAccumulatorHealthy(s) {
        if (s.bitOffset > 32) throw "Accumulator underloaded: " + s.bitOffset;
    }
    /**
   * @param {!State} s
   * @param {number} n
   ...
   */ function jumpToByteBoundary(s) {
        ...
        if (padding != 0) {
            ...
            if (paddingBits != 0) throw "Corrupted padding bits";
        }
    }
    /**
   * @param {!State} s
   ...
   */ function copyBytes(s, data, offset, length) {
        if ((s.bitOffset & 7) != 0) throw "Unaligned copyBytes";
   ...
   */ function bytesToNibbles(s, byteLen) {
        ...
        for(var /** number */ i = 0; i < halfLen; ++i)shortBuffer[i] = byteBuffer[i * 2] & 255 | (byteBuffer[i * 2 + 1] & 255) << 8;
    }
   ...
   */ function unpackLookupTable(lookup, map, rle) {
        ...
        for(var /** number */ i = 0; i < 128; ++i)lookup[1024 + i] = 4 * (map.charCodeAt(i) - 32);
        ...
        for(var /** number */ k = 0; k < 19; ++k){
            ...
            for(var /** number */ i = 0; i < rep; ++i)lookup[offset++] = value;
        }
        ...
        lookup[1792] = 0;
        lookup[2047] = 7;
        for(var /** number */ i = 0; i < 256; ++i)lookup[1536 + i] = lookup[1792 + i] << 3;
    }
   ...
   * @struct
   */ function State() {
        /** @type {!Int8Array} */ this.ringBuffer = new Int8Array(0);
        /** @type {!Int8Array} */ this.contextModes = new Int8Array(0);
        /** @type {!Int8Array} */ this.contextMap = new Int8Array(0);
        /** @type {!Int8Array} */ this.distContextMap = new Int8Array(0);
        /** @type {!Int8Array} */ this.distExtraBits = new Int8Array(0);
        /** @type {!Int8Array} */ this.output = new Int8Array(0);
        /** @type {!Int8Array} */ this.byteBuffer = new Int8Array(0);
        /** @type {!Int16Array} */ this.shortBuffer = new Int16Array(0);
        /** @type {!Int32Array} */ this.intBuffer = new Int32Array(0);
        /** @type {!Int32Array} */ this.rings = new Int32Array(0);
        /** @type {!Int32Array} */ this.blockTrees = new Int32Array(0);
        /** @type {!Int32Array} */ this.literalTreeGroup = new Int32Array(0);
        /** @type {!Int32Array} */ this.commandTreeGroup = new Int32Array(0);
        /** @type {!Int32Array} */ this.distanceTreeGroup = new Int32Array(0);
        /** @type {!Int32Array} */ this.distOffset = new Int32Array(0);
        /** @type {!number} */ this.runningState = 0;
        /** @type {!number} */ this.nextRunningState = 0;
        /** @type {!number} */ this.accumulator32 = 0;
        /** @type {!number} */ this.bitOffset = 0;
        /** @type {!number} */ this.halfOffset = 0;
        /** @type {!number} */ this.tailBytes = 0;
        /** @type {!number} */ this.endOfStreamReached = 0;
        /** @type {!number} */ this.metaBlockLength = 0;
        /** @type {!number} */ this.inputEnd = 0;
        /** @type {!number} */ this.isUncompressed = 0;
        /** @type {!number} */ this.isMetadata = 0;
        /** @type {!number} */ this.literalBlockLength = 0;
        /** @type {!number} */ this.numLiteralBlockTypes = 0;
        /** @type {!number} */ this.commandBlockLength = 0;
        /** @type {!number} */ this.numCommandBlockTypes = 0;
        /** @type {!number} */ this.distanceBlockLength = 0;
        /** @type {!number} */ this.numDistanceBlockTypes = 0;
        /** @type {!number} */ this.pos = 0;
        /** @type {!number} */ this.maxDistance = 0;
        /** @type {!number} */ this.distRbIdx = 0;
        /** @type {!number} */ this.trivialLiteralContext = 0;
        /** @type {!number} */ this.literalTreeIdx = 0;
        /** @type {!number} */ this.commandTreeIdx = 0;
        /** @type {!number} */ this.j = 0;
        /** @type {!number} */ this.insertLength = 0;
        /** @type {!number} */ this.contextMapSlice = 0;
        /** @type {!number} */ this.distContextMapSlice = 0;
        /** @type {!number} */ this.contextLookupOffset1 = 0;
        /** @type {!number} */ this.contextLookupOffset2 = 0;
        /** @type {!number} */ this.distanceCode = 0;
        /** @type {!number} */ this.numDirectDistanceCodes = 0;
        /** @type {!number} */ this.distancePostfixMask = 0;
        /** @type {!number} */ this.distancePostfixBits = 0;
        /** @type {!number} */ this.distance = 0;
        /** @type {!number} */ this.copyLength = 0;
        /** @type {!number} */ this.maxBackwardDistance = 0;
        /** @type {!number} */ this.maxRingBufferSize = 0;
        /** @type {!number} */ this.ringBufferSize = 0;
        /** @type {!number} */ this.expectedTotalSize = 0;
        /** @type {!number} */ this.outputOffset = 0;
        /** @type {!number} */ this.outputLength = 0;
        /** @type {!number} */ this.outputUsed = 0;
        /** @type {!number} */ this.ringBufferBytesWritten = 0;
        /** @type {!number} */ this.ringBufferBytesReady = 0;
        /** @type {!number} */ this.isEager = 0;
        /** @type {!number} */ this.isLargeWindow = 0;
        /** @type {!InputStream|null} */ this.input = null;
   ...
   */ function toUsAsciiBytes(src) {
        ...
        for(var /** !number */ i = 0; i < n; ++i)result[i] = src.charCodeAt(i);
        return result;
    }
    /**
   * @param {!Int8Array} bytes
...
let $4850934860c39869$export$1555b7dee2589cbb = $4850934860c39869$var$BrotliDecodeClosure(); // /** @export */
 // var BrotliDecode = BrotliDecodeClosure();
 // window["BrotliDecode"] = BrotliDecode;


const $7c7ada5680ab6293$var$typedArrayMapping = {
    "int8": Int8Array,
    "int16": Int16Array,
    "int32": Int32Array,
    "int64": Float64Array,
...
function $7c7ada5680ab6293$var$dealign24b(mortoncode) {
...
let $7c7ada5680ab6293$var$mask_b0 = new Uint8Array([
    0,
    1,
    0,
    1,
...
onmessage = function(event) {
    let { pointAttributes: pointAttributes , scale: scale , name: name , min: min , max: max , size: size , offset: offset , numPoints: numPoints  } = event.data;
    let tStart = performance.now();
    let buffer = $4850934860c39869$export$1555b7dee2589cbb(new Int8Array(event.data.buffer));
    ...
    for (let pointAttribute1 of pointAttributes.attributes){
        if ([
            ...
            for(let j = 0; j < numPoints; j++){
                ...
                byteOffset += 16;
                let X = $7c7ada5680ab6293$var$dealign24b((mc_3 & 16777215) >>> 0) | $7c7ada5680ab6293$var$dealign24b((mc_3 >>> 24 | mc_2 << 8) >>> 0) << 8;
                let Y = $7c7ada5680ab6293$var$dealign24b((mc_3 & 16777215) >>> 1) | $7c7ada5680ab6293$var$dealign24b((mc_3 >>> 24 | mc_2 << 8) >>> 1) << 8;
                let Z = $7c7ada5680ab6293$var$dealign24b((mc_3 & 16777215) >>> 2) | $7c7ada5680ab6293$var$dealign24b((mc_3 >>> 24 | mc_2 << 8) >>> 2) << 8;
                if (mc_1 != 0 || mc_2 != 0) {
                    X = X | $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 0) << 16 | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 0) << 24;
                    Y = Y | $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 1) << 16 | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 1) << 24;
                    Z = Z | $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 2) << 16 | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 2) << 24;
                }
                // =======================
            ...
            for(let j = 0; j < numPoints; j++){
                ...
                let mc_1 = view.getUint32(byteOffset + 0, true);
                byteOffset += 8;
                let r = $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 0) | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 0) << 8;
                let g = $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 1) | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 1) << 8;
                let b = $7c7ada5680ab6293$var$dealign24b((mc_1 & 16777215) >>> 2) | $7c7ada5680ab6293$var$dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 2) << 8;
            ...
            let TypedArray = $7c7ada5680ab6293$var$typedArrayMapping[pointAttribute1.type.name];
            ...
            for(let j = 0; j < numPoints; j++){
                ...
                byteOffset += pointAttribute1.byteSize;
    ...
    // console.log(`${name}: #points: ${numPoints}: #occupiedCells: ${numOccupiedCells}, occupancy: ${occupancy} points/cell`);
    {
        ...
        attributeBuffers["INDICES"] = {
            buffer: buff,
            attribute: $23fd448c909cb165$export$4fe36b08757d7602.INDICES
        };
    }
    {
        ...
        for (let vector of vectors){
            ...
            let vecAttribute = new $23fd448c909cb165$export$4fe36b08757d7602(name, $23fd448c909cb165$export$4a34a80e6342e491.DATA_TYPE_FLOAT, 3);
...
//# sourceMappingURL=brotli-decoder.worker.c1e936e0.js.map
