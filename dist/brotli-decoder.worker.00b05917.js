...
})({"f7UUh":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "a8fb9c35fdafe466";
module.bundle.HMR_BUNDLE_ID = "58c77a7200b05917";
...
},{}],"biT84":[function(require,module,exports) {
var _pointAttributes = require("./PointAttributes");
var _decode = require("./libs/brotli/decode");
...
onmessage = function(event) {
    ...
    let buffer = _decode.BrotliDecode(new Int8Array(event.data.buffer));
    ...
    for (let pointAttribute1 of pointAttributes.attributes){
        if ([
            ...
            for(let j = 0; j < numPoints; j++){
                ...
                let mc_1 = view.getUint32(byteOffset + 0, true);
                byteOffset += 8;
                let r = dealign24b((mc_1 & 16777215) >>> 0) | dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 0) << 8;
                let g = dealign24b((mc_1 & 16777215) >>> 1) | dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 1) << 8;
                let b = dealign24b((mc_1 & 16777215) >>> 2) | dealign24b((mc_1 >>> 24 | mc_0 << 8) >>> 2) << 8;
...
},{"./PointAttributes":"14KXh","./libs/brotli/decode":"9H5jk"}],"14KXh":[function(require,module,exports) {
...
},{}],"9H5jk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BrotliDecode", ()=>BrotliDecode
);
/* Copyright 2017 Google Inc. All Rights Reserved.

   Distributed under MIT license.
   See file LICENSE for detail or copy at https://opensource.org/licenses/MIT
*/ /** @return {function(!Int8Array):!Int8Array} */ function BrotliDecodeClosure() {
...
let BrotliDecode = BrotliDecodeClosure(); // /** @export */
 // var BrotliDecode = BrotliDecodeClosure();
 // window["BrotliDecode"] = BrotliDecode;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}]},["f7UUh","biT84"], "biT84", "parcelRequirefa99")

//# sourceMappingURL=brotli-decoder.worker.00b05917.js.map
